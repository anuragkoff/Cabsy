      ...
      <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
        <div className="flex relative pb-12">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Select your starting point and destination</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">See Availability</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Choose your ride</p>
          </div>
        </div>
        <div className="flex relative pb-12">
          <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Create your account</p>
          </div>
        </div>
        <div className="flex relative">
          ...
          <div className="flex-grow pl-4">
            ...
            <p className="leading-relaxed">Complete Payment and Book your seat</p>
          </div>
        </div>
      </div>
